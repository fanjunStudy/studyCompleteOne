        ...
        bindEvent: function (type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn title">选择日期</div>' +
                    '<div class="date_btn lcalendar_finish"><span>确定</span></div>' +
                    '</div>' +
            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    if (!isNaN(top)) {
                        ...
                        date_yy.setAttribute('top', 12 - yyVal * 2 + 'em');
                    }
                } else {
                    return;
                }
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    console.log(date_mm,parseInt(date_mm.getAttribute("val")))
                    itemStr = "";
                    //得到月份的值
                    var mmVal = parseInt(date_mm.getAttribute("val"));
                    var maxM = 11;
                    var minM = 0;
                    // console.log(yyVal,passY)
                    //当年份到达最大值
                    if (yyVal == passY - 1) {
                        maxM = _self.maxM - 1;
                    }
            ...
            function gearTouchStart(e) {
                ...
                if (top) {
                    ...
                    console.log(target["o_d_" + target.id])
                } else {
                ...
                target["int_" + target.id] = setInterval(function () {
                    ...
                    switch (target.dataset.datetype) {
                        ...
                        case "date_mm":
                            ...
                            console.log(top,minTop,'移动时top最小')
                            if (pos < minTop) {
                                pos = minTop;
                                stopGear = true;
                            }
            ...
            function setGear(target, val) {
                val = Math.round(val);
                console.log(target,val,'控制插件滚动后停留的值')
            ...
            function finishMobileDateTime(e) {
                ...
                _self.trigger.value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd + " " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm + ":59";
                _self.value = _self.trigger.value;
                if (_self.onSubmit) _self.onSubmit();
                closeMobileCalendar(e);
            }
